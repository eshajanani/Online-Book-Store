        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name!=false) {
                    ...
                    $sql = "INSERT INTO user (email, user_fname, user_lname, user_id, user_password)
                            VALUES('" . $user_email . "','" . $user_fname . "','" . $user_lname . "','" . $user_id . "', '" . $user_password_hash . "');";
